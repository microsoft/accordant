...
- **Language-independent testing** — Your system doesn't *have* to be in .NET. Export test plans to JSON, execute from any language, and validate traces against the spec. → [Testing Any System](how-to/testing-any-system.md)
