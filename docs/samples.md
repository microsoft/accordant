...
| [TodoList-FaultInjection](../Samples/TodoList-FaultInjection/) | Demonstrates indefinite failure handling with server-side and client-side fault injection. See [Indefinite Failures](how-to/indefinite-failures.md). |
