namespace DiningPhilosophers
{
    ...
    public class DiningGraphProbeTests
    {
        ...
        {
            var root = StateGraph.ExploreStateGraph(Dining.AllSteps(asymmetric: false), Dining.InitialState(), lazy: true);
        ...
        {
            var root = StateGraph.ExploreStateGraph(Dining.AllSteps(asymmetric: true), Dining.InitialState(), lazy: true);
            var (states, deadlocks) = Walk(root);
