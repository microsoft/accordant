...
- `GetJob` is a **step function** — when we poll, we might observe either `Pending` or `Completed`
- The model branches on both possibilities until we observe the actual state
