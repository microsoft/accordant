namespace Accordant.ModelChecking.Tests.Symbolic
{
    ...
    public class BoundedModelCheckingE2ETests
    {
        ...
        private sealed class IncrementOp : BaseStepFunction
        {
        ...
        private sealed class DecrementOp : BaseStepFunction
        {
        ...
        private sealed class ChangeColorOp : BaseStepFunction
        {
        ...
        private sealed class ProduceOp : BaseStepFunction
        {
        ...
        private sealed class ConsumeOp : BaseStepFunction
        {
        ...
        private sealed class P1EnterOp : BaseStepFunction
        {
        ...
        private sealed class P1ExitOp : BaseStepFunction
        {
        ...
        private sealed class P2EnterOp : BaseStepFunction
        {
        ...
        private sealed class P2ExitOp : BaseStepFunction
        {
        ...
        /// </summary>
        private sealed class BuggyDecrementOp : BaseStepFunction
        {
